...
namespace GazeMetrics
{
    ...
    [CreateAssetMenu(fileName = "Circle GazeMetrics Targets", menuName = "GazeMetrics/CircleGazeMetricsTargets", order = 2)]
    public class CircleCalibrationTargets : GazeMetricsTargets
    {
        [System.Serializable]
